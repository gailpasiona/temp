...
trait HasRole
{
    ...
    {
        return $this->belongsToMany(Config::get('entrust::role'), Config::get('entrust::assigned_roles_table'), 'user_id', 'role_id');//->withPivot('company_id');//where('assigned_roles.company_id', '=', '1');
    }
