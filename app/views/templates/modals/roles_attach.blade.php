  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Attach Users to <strong>{{$role}}</strong> Role</h4>
      </div>
        ...
        <form id="roles_form" accept-charset="UTF-8">
          ...
          <fieldset>
              ...
              <div class="form-group">
                    ...
                    <label>Non-Member Users</label>

                  <div class="role_checkbox col-md-12">
                    <div class="">
                      @foreach($users_list as $user)
                          <label>
                            <input type="checkbox" value="{{{$user['id']}}}" name="users[]" id="users[]">
                            {{{$user['full_name']}}}
                          </label>
                          &nbsp;
                      @endforeach
