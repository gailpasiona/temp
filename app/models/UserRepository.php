...
class UserRepository
{
    ...
    public function signup($input)
    {
        ...
        $user->full_name = array_get($input, 'full_name');
        $user->email = array_get($input, 'username') . '@company.com';
    ...
    public function update($data){
        ...
        $type = array_get($data,'password');
        if($type == "") {
            $user->username = array_get($data,'username');
            $user->full_name = array_get($data,'full_name');
        } else {
